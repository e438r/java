        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="javascript:void(0);" class="waves-effect waves-dark"><i class="fa fa-dashboard"></i> 用户管理</a>
                    </li>
                    <li>
                        <a href="javascript:void(0);" class="waves-effect waves-dark"><i class="fa fa-desktop"></i> 预约管理</a>
                    </li>
					<li>
                        <a href="javascript:void(0);" class="waves-effect waves-dark"><i class="fa fa-bar-chart-o"></i> 分类管理</a>
                    </li>
                    <li>
